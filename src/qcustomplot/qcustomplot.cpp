...
{
  // Mouse range dragging interaction:
	if (mDragging && mParentPlot->interactions().testFlag(QCP::iRangeDrag) && event->modifiers() == Qt::ShiftModifier)
  {
...
*/
QCPGraph::QCPGraph(QCPAxis *keyAxis, QCPAxis *valueAxis) : QCPAbstractPlottable(keyAxis, valueAxis), mfreeDataMemory(true)
{
...
*/
void QCPGraph::setData(QCPDataMap *data, bool copy, bool freeMemory)
{
	mfreeDataMemory = freeMemory;
  if (mData == data)
  {
